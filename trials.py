...
# New lines for joint space trajectory using jtraj
q_start = mh5.qz  # Starting from zero configuration
q_end = sol.q[-1] if sol.success else mh5.qz  # End at last IK solution or zero if no solution
steps = 100  # Number of steps for interpolation
q_traj = jtraj(q_start, q_end, steps).q  # Joint trajectory from start to end

# Visualize robot executing the joint space trajectory
if sol.success:
    ...
    print("No joint space trajectory due to failed IK!")
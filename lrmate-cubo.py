...
mh5 = DHRobot([
    ...
    RevoluteDH(d=0.0, a=0.33, alpha=0, offset = -np.pi/2, qlim=[-2.14, 2.14]),  # Joint 2: θ2, d=0, a=88mm, α=90°
    RevoluteDH(d=0.0, a=0.035, alpha=-np.pi/2, qlim=[-3.67, 3.67]),  # Joint 3: θ3, d=0, a=310mm, α=0°
    RevoluteDH(d=0.335, a=0.0, alpha=np.pi/2, qlim=[-3.31, 3.31]),  # Joint 4: θ4+90°, d=305mm, a=40mm, α=90°
